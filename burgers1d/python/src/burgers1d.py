...
def velocityImplNumba(u, t, f, expVec_, dxInv_, mu0):
  f[0] = 0.5 * dxInv_ * (mu0**2 - u[0]**2)
  for i in range(1,len(u)):
    f[i] = 0.5 * dxInv_ * ( u[i-1]**2 - u[i]**2 )
...
class Burgers1d:
  ...
  #   u, t = args[0], args[1]
  #   if len(args) == 2:
  #     #jacobianImplVectorize(u, t, self.J_, self.dxInv_, self.Ncell_)
  #     jacobianImplNumba(u, t, self.J_, self.dxInv_, self.Ncell_)
  #     return self.J_
  #   else:
  #     #jacobianImplVectorize(u, t, args[2], self.dxInv_, self.Ncell_)
